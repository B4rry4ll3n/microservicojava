...
public class EmailService extends Thread {
	...
	public void run() {
		...
		prop.put("mail.smtp.host", System.getProperty("email-projetct.mail.smtp.host"));
		prop.put("mail.smtp.port", System.getProperty("email-projetct.mail.smtp.port"));
		...
		for (Email email : emails) {
			...
			try {
				...
				message.setFrom(new InternetAddress(System.getProperty("email-projetct.mailfrom")));
